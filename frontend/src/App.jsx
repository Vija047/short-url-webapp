          ...
          {shortUrl && (
            <div className="mt-8 p-6 bg-green-50 border border-green-200 rounded-lg">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-green-700 mb-2">Your short URL:</label>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="p-4 bg-gray-50 rounded-lg">
                <h4 className="font-semibold text-gray-700 mb-2">Original URL</h4>
                <p className="text-sm text-gray-600 break-all">{stats.longUrl}</p>
              </div>
              
              <div className="p-4 bg-gray-50 rounded-lg">
                <h4 className="font-semibold text-gray-700 mb-2">Created Date</h4>
                <p className="text-sm text-gray-600">{new Date(stats.createdAt).toLocaleString()}</p>
              </div>
              
              <div className="p-4 bg-indigo-50 rounded-lg md:col-span-2">
                <h4 className="font-semibold text-indigo-700 mb-2">Total Visits</h4>
                <p className="text-3xl font-bold text-indigo-600">{stats.visitCount}</p>
              </div>
            </div>
          </div>
        )}
